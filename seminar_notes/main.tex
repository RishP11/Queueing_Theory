...
\begin{center}
    \begin{tabular}{|c|c|c|}
        \hline
        Queueing Model & State Probability Distribution & Examples \\
        \hline
        \hline
        $M/M/1$ & 
        \begin{tabular}{@{}l@{}} 
        ...
        $p_n = \rho^n p_0$ 
        \end{tabular} &
        Queue at a call center, single ATM, etc. \\       
        \hline
        $M/M/1/N$ & $p_n = \big(\frac{1 - \rho}{1 - \rho ^ {N + 1}}\big) \rho ^ n\ \quad\ \ldots\ 0\leq n \leq N.$ & Airports, Hospitals, etc. \\
        \hline
        ...
        \end{tabular} & Multi-core Processors \\ 
        \hline
    \end{tabular}
\end{center}
